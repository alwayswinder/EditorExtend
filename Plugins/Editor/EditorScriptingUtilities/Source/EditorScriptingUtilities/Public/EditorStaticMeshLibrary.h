...
public:
	...
	UFUNCTION(BlueprintCallable, Category = "Editor Scripting | StaticMesh")
	static bool ResetSectionmaterialBySlotName(UStaticMesh* StaticMesh, FName SlotName, int32 LODIndex, int32 SectionIndex);


	UFUNCTION(BlueprintCallable, Category = "Editor Scripting | StaticMesh")
	static bool ResetSectionmaterialByIndex(UStaticMesh* StaticMesh, int32 MaterialIndex, int32 LODIndex, int32 SectionIndex);
