...
bool UEditorStaticMeshLibrary::ResetSectionmaterialBySlotName(UStaticMesh* StaticMesh, FName SlotName, int32 LODIndex, int32 SectionIndex)
{
	if (StaticMesh != NULL)
	{
		int32 Materialindex = StaticMesh->GetMaterialIndex(SlotName);
		if (Materialindex != -1)
		{
...
bool UEditorStaticMeshLibrary::ResetSectionmaterialByIndex(UStaticMesh* StaticMesh, int32 MaterialIndex, int32 LODIndex, int32 SectionIndex)
{

	if (StaticMesh != NULL)
	{
		if (MaterialIndex >= 0 && MaterialIndex < StaticMesh->StaticMaterials.Num())
		{
...
bool UEditorStaticMeshLibrary::ResetMaterialSlotNames(UStaticMesh* StaticMesh, FName newSlotname)
{
	if (StaticMesh != NULL)
	{
