...
#define ORIGINAL_FILE_NAME "UE4Editor-ReflectionDataPanel.dll"
#define UE_IS_ENGINE_MODULE 0
#define UE_PROJECT_NAME EditExtend01
...
#define REFLECTIONDATAPANEL_API DLLEXPORT
